...
all_outputs_wmeta %>% 
  ...
  na.omit() %>%
  ggplot()+
  geom_line(aes(x= dates, y=flow_m3s_fire/100), color='red')+
  geom_line(aes(x= dates, y=flow_m3s_nofire/100), color='blue')+
  geom_point(aes(x= dates, y=sed_mgL_.chg, color=ShortScenario))+
  theme_classic()+
  labs(x = "date", y = "% Change in Nitrate from Base Unburnt Condition")+
  theme(legend.position="right", 
        plot.title =  element_text(size=12),axis.text.y=element_text(size=12,
...
all_outputs_wmeta %>% 
  ...
  geom_point(aes(x= dates, y=sed_mgL_.chg, color=ShortScenario))+
  theme_classic()+
  labs(x = "date", y = "% Change in TSS from Base Unburnt Condition")+
  theme(legend.position="right", 
        plot.title =  element_text(size=12),axis.text.y=element_text(size=12,
                                                                     color="black"),
        axis.title.y=element_text(size=12),
