...
metadata <- metadata %>% 
  mutate(metadata, TSF = ifelse(grepl("12-13", Time_Since_Fire), ">10 years",
                              ifelse(grepl("0|0-1|0-2|1 month|1|2|1-2", Time_Since_Fire), "0-2 years",
                              ifelse(grepl("3|4|5", Time_Since_Fire), "3-5 years",
...
level_order <- c('0-2 years', '3-5 years', '>10 years') 
