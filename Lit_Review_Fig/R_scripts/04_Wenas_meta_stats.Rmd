...
level_order <- c('0-1 years', '2-3 years', '>10 years') 
...
# fire
mDOC_fire <- lmer(Effect_size ~ TSF + (1|Study_ID), data = effect_size_DOC)

plot(mDOC_fire)
qqnorm(resid(mDOC_fire))

anova(mDOC_fire) # f-value = 0.7755
...
mNO3_TSF <- lmer(Effect_size ~ TSF + (1|Study_ID), data = effect_size_NO3)
